...
LOC_7B4E:       CALL    CLS
                ...
                LD      HL, (WORD_8655+1)
                CALL    SUB_81EA
                LD      A, (BYTE_865E) ; Цвет зелёного верхнего игрока
                LD      (SWTMP), A
                LD      DE, #0x90E
                LD      HL, #DATA_992C
                LD      BC, #0x1803
                ...
                LD      HL, (WORD_8657)
                CALL    SUB_81EA
                LD      A, (BYTE_865F) ; Цвет голубого среднего игрока
                LD      (SWTMP), A
                LD      DE, #0x916
                LD      HL, #DATA_9A94
                LD      BC, #0x1803
...
; =============== S U B R O U T I N E =======================================
; Анимация: красный нижний игрок берёт карту

SUB_7C98:       LD      A, (BYTE_865D) ; Цвет красного нижнего игрока
                LD      (SWTMP), A
                LD      DE, #0x131C
                LD      HL, #DATA_9CD4
                LD      BC, #0x1803
                ...
                CALL    WAIT_5
                CALL    SPRITE
                LD      HL, #DATA_9C8C ; Красный нижний игрок
                CALL    WAIT_5
                JP      SPRITE

; =============== S U B R O U T I N E =======================================
; Красный нижний игрок крутит головой

SUB_7CC8:       LD      A, (BYTE_865D) ; Цвет красного нижнего игрока
                LD      (SWTMP), A
                LD      DE, #0x131C
                LD      HL, #DATA_9D64
                LD      BC, #0x1803
...
; =============== S U B R O U T I N E =======================================
; Анимация: зелёный верхний игрок берёт карту

SUB_7CF8:       LD      A, (BYTE_865E) ; Цвет зелёного верхнего игрока
                LD      (SWTMP), A
                LD      DE, #0x21C
                LD      HL, #DATA_9974
                LD      BC, #0x1803
...
; =============== S U B R O U T I N E =======================================
; Зелёный верхний игрок крутит головой

SUB_7D28:       LD      A, (BYTE_865E) ; Цвет зелёного верхнего игрока
                LD      (SWTMP), A
                LD      DE, #0x21C
                LD      HL, #DATA_9A04
                LD      BC, #0x1803
...
; =============== S U B R O U T I N E =======================================
; Анимация: голубой средний игрок берёт карту

SUB_7D58:       LD      A, (BYTE_865F) ; Цвет голубого среднего игрока
                LD      (SWTMP), A
                LD      DE, #0x0D1C
                LD      HL, #DATA_9ADC
                LD      BC, #0x1803
...
; =============== S U B R O U T I N E =======================================
; Голубой средний игрок крутит головой

SUB_7D88:       LD      A, (BYTE_865F) ; Цвет голубого среднего игрока
                LD      (SWTMP), A
                LD      DE, #0xD1C
                LD      HL, #DATA_9B6C
                LD      BC, #0x1803
...
SUNDUK_2:       LD      A, (BYTE_8660)
                LD      (SWTMP), A
                LD      DE, #0x81C
                LD      HL, #DATA_9C44  ; Другая фаза жёлтого сундука (открыт)
                LD      BC, #0x1803
                JP      SPRITE
...
SUNDUK:         LD      A, (BYTE_8660)
                LD      (SWTMP), A
                LD      DE, #0x81C
                LD      HL, #DATA_9BFC  ; Жёлтый сундук-банк
                LD      BC, #0x1803
                JP      SPRITE
...
SUB_7F00:       LD      A, (SWCLS)
                ...
                LD      HL, #0x881C
                LD      IX, #0x86C2
                LD      DE, #0x200      ; Координаты начала рядов карт
                LD      A, (BYTE_86E6)
                CALL    SUB_7F25
                LD      A, (BYTE_86E7)
                CALL    SUB_7F25
                ...
                CALL    SUB_7F25
                LD      A, (BYTE_86E7)
SUB_7F25:       LD      B, #9           ; Количество карт в ряду
                PUSH    DE
LOC_7F28:       PUSH    BC
                PUSH    AF
                LD      (SWTMP), A
                ...
                JR      NZ, LOC_7F46
                PUSH    HL
                LD      A, (SWCLS)      ; Цвет контура карты
                LD      (SWTMP), A
                LD      HL, #DATA_959C  ; Контур карты
                LD      BC, #0x2003     ; Размер контура карты
                CALL    SPRITE          ; Вывод контура карты
                POP     HL
                JR      LOC_7F4C
; ---------------------------------------------------------------------------
...
INIT_RSRC:      LD      HL, #DATA_8662  ; Пустой спрайт
                LD      DE, #0x86C2
                LD      BC, #0x24
                LDIR
                LD      DE, #DATA_86E8
...
LOC_812D:       CALL    SUB_832A
                LD      A, (SWCLS)
                LD      (SWTMP), A
                LD      HL, #DATA_96FC  ; Логотип Чепрасова
                LD      DE, #0x20B
                LD      BC, #0x380A
                CALL    SPRITE
...
SUB_8238:       LD      A, (BYTE_865E)  ; Цвет зелёного верхнего игрока
                LD      (SWTMP), A
                LD      DE, #0x21C      ; Координаты спрайта зелёного игрока
                LD      HL, #DATA_992C  ; Зелёный верхний игрок
                LD      BC, #0x1803     ; Размер спрайта зелёного игрока
                CALL    SPRITE          ; Вывод
                LD      HL, #DATA_9DF4
                LD      DE, #0x51B
                LD      BC, #0x804
                CALL    SPRITE          ; Вывести карты зелёного игрока
                LD      A, (BYTE_8660)  ; Установим жёлтый цвет
                LD      (SWTMP), A
                LD      DE, #0x81C
                LD      HL, #DATA_9BFC
                LD      BC, #0x1803
                CALL    SPRITE          ; Вывести жёлтый сундук-банк
                LD      A, (BYTE_865F)  ; Цвет голубого среднего игрока
                LD      (SWTMP), A
                LD      DE, #0x0D1C
                LD      HL, #DATA_9A94
                LD      BC, #0x1803
                CALL    SPRITE          ; Вывести голубого среднего игрока
                LD      HL, #DATA_9DF4
                LD      DE, #0x101B
                LD      BC, #0x804
                CALL    SPRITE          ; Вывести карты голубого игрока
                LD      A, (BYTE_865D)
                LD      (SWTMP), A
                LD      DE, #0x131C
                LD      HL, #DATA_9C8C
                LD      BC, #0x1803
                CALL    SPRITE          ; Вывести красного нижнего игрока
                LD      HL, #DATA_9DF4
                LD      DE, #0x161B
                LD      BC, #0x804
                CALL    SPRITE          ; Вывести карты красного игрока
                JP      SUB_81B1

; =============== S U B R O U T I N E =======================================

SUB_82A7:       LD      A, (BYTE_865E)  ; Цвет зелёного верхнего игрока
                LD      (SWTMP), A
                LD      HL, #DATA_8662  ; Пустой спрайт
                LD      A, (BYTE_8710)
                AND     A
...
; =============== S U B R O U T I N E =======================================
; Переход на нижнюю строку (в графических координатах)
...
; =============== S U B R O U T I N E =======================================
; Пересчёт координат в знакоместах в координаты экрана
;  Вход: DE - Y, X
;  Выход: DE - адрес в экране
...
CLS:            LD      A, (SWPAP)      ; Берём цвет бордюра
                ...
                INC     HL
                LD      A, (SWCLS)      ; Берём постоянный цвет
                LD      (SWTMP), A  ; И устанавливаем им временный цвет
                LD      (HL), A
                INC     DE
                LD      BC, #0x2FF
...
BYTE_865B: .DB 0
BYTE_865C: .DB 0
BYTE_865D: .DB 0x42  ; Цвет красного нижнего игрока
BYTE_865E: .DB 0x44  ; Цвет зелёного верхнего игрока
BYTE_865F: .DB 0x45  ; Цвет голубого среднего игрока
BYTE_8660: .DB 0x46  ; Цвет жёлтого сундука-банка
BYTE_8661:      .DB 0

DATA_8662: ; Пустой спрайт 32x3 = 96 байт
...
SWTMP:     .DB 0x46                ; Временный атрибут цвета
SWPAP:     .DB 0                   ; Цвет бордюра
SWCLS:     .DB 7                   ; Постоянный атрибут цвета
BYTE_880B:      .DB 0x9E
                .DB    0
                .DB    0
BYTE_880E:      .DB 0
...
WORD_8814:      .DW 0
                ...
                .DB    1
                .DB    9
BYTE_881B: .DB 0 ; Инициализация игры. Проверятся при старте
...
DATA_9974: ; Зелёный верхний игрок, фаза 2
...
DATA_99BC: ; Зелёный верхний игрок, фаза 3
...
DATA_9A04: ; Зелёный верхний игрок, фаза 4
...
DATA_9A4C: ; Зелёный верхний игрок, фаза 5
...
DATA_9C44: ; Другая фаза жёлтого сундука (открыт)
...
DATA_9C8C: ; Красный нижний игрок
...
DATA_9CD4: ; Красный нижний игрок, фаза 2
...
DATA_9D1C: ; Красный нижний игрок, фаза 3
...
DATA_9D64: ; Красный нижний игрок, фаза 4
...
DATA_9DAC: ; Красный нижний игрок, фаза 5
